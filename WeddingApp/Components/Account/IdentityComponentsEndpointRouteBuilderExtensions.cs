...
using WeddingApp.Components.Account.Pages;
using WeddingApp.Components.Account.Pages.Manage;
...
internal static class IdentityComponentsEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapAdditionalIdentityEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        accountGroup.MapPost("/PerformExternalLogin", (
            HttpContext context,
            [FromServices] SignInManager<WeddingAppUser> signInManager,
        ...
        manageGroup.MapPost("/DownloadPersonalData", async (
            HttpContext context,
            [FromServices] UserManager<WeddingAppUser> userManager,
            [FromServices] AuthenticationStateProvider authenticationStateProvider) =>
        {
            ...
            var personalDataProps = typeof(WeddingAppUser).GetProperties().Where(
